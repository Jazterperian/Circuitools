    ...
    class TouchManipulationBitmap
    {
        ...
        public bool HitTest(SKPoint location)
        {
            ...
            if (Matrix.TryInvert(out inverseMatrix))
            {
                ...
                SKRect rect = new SKRect(0, 0, bitmap.Width, bitmap.Height); return rect.Contains(transformedPoint);
            }
            return false;
        }
        ...
        void Manipulate()
        {
            ...
            SKMatrix matrix = Matrix; matrix = matrix.PostConcat(touchMatrix); Matrix = matrix;
        }
    }
}
